...
3. The login page appears at `/login`

**Development URL:** http://localhost:3000  
**Default admin account (development):** username `admin`, password `Admin@123` (seeded by the API on first run).
...
| Menu item | Route | Who can use |
|-----------|-------|-------------|
| Dashboard | `/dashboard` | All roles |
| Devices | `/devices` | All roles |
| Sensors | `/sensors` | All roles |
| Actuators | `/actuators` | All roles |
| Alert Rules | `/alert-rules` | All roles |
| Alerts | `/alerts` | All roles |
| Command History | `/command-history` | All roles |
| Users | `/users` | **Admin only** |

**Roles:** **Viewer** — read-only. **Operator** and **Admin** — can add, edit, and delete devices, sensors, actuators, and alert rules. **Admin** — additionally manages users.
