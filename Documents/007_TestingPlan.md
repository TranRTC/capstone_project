...
### 1.4 Related testing documents (`Documents/testing/`)

This document is the **formal test plan** (capstone doc 007). Execution artifacts are kept in the same `Documents/` tree:

| File | Purpose |
|------|---------|
| [testing/MANUAL_TEST_CHECKLIST.md](testing/MANUAL_TEST_CHECKLIST.md) | Step-by-step manual tests (UI, SignalR, MQTT, demo script) |
| [testing/AUTOMATED_TEST_RESULTS.md](testing/AUTOMATED_TEST_RESULTS.md) | Record of the latest automated API test run |
| [testing/Run-ApiTests.ps1](testing/Run-ApiTests.ps1) | PowerShell script to re-run REST API tests against `http://localhost:5000` |

Presentation demo steps align with **Phase 8** in the manual checklist. Slides: [Presentation/](Presentation/).
...
- **Backend:** Local development server (`http://localhost:5000`)
