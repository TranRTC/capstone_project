...
- **Documentation:** Formal docs in `Documents/`; test execution in `Documents/testing/`

### 1.4 Implementation status

The capstone system described in this guide has been **built**. Repository layout:

- `Backend/` — four .NET 8 projects (API, Core, Infrastructure, Services)
- `Frontend/iot-monitoring-frontend/` — React 18 + TypeScript + MUI (CRA)
- `Documents/` — `001`–`010` specifications; `testing/` and `Presentation/` subfolders

Local run: API `http://localhost:5000`, frontend `http://localhost:3000`, MQTT broker `localhost:1883`.
