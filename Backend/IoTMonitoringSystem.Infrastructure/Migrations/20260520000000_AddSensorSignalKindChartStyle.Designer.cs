...
namespace IoTMonitoringSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260520000000_AddSensorSignalKindChartStyle")]
    partial class AddSensorSignalKindChartStyle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IoTMonitoringSystem.Core.Entities.Actuator", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ActuatorId"));

                    b.Property<decimal?>("AnalogMax")
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal?>("AnalogMin")
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.Property<int?>("FeedbackSensorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IoTMonitoringSystem.Core.Entities.DeviceCommand", b =>
                {
                    b.Property<long>("CommandId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("CommandId"));
                    ...
                    b.HasIndex("DeviceId", "ActuatorId");
            ...
            modelBuilder.Entity("IoTMonitoringSystem.Core.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("IoTMonitoringSystem.Core.Entities.Actuator", b =>
                {
                    ...
                    b.HasOne("IoTMonitoringSystem.Core.Entities.Sensor", "FeedbackSensor")
                        .WithMany("ActuatorsUsingAsFeedback")
                        .HasForeignKey("FeedbackSensorId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Device");

                    b.Navigation("FeedbackSensor");
                });
            ...
            modelBuilder.Entity("IoTMonitoringSystem.Core.Entities.DeviceCommand", b =>
                {
                    b.HasOne("IoTMonitoringSystem.Core.Entities.Actuator", "Actuator")
            ...
            modelBuilder.Entity("IoTMonitoringSystem.Core.Entities.Sensor", b =>
                {
                    b.Navigation("ActuatorsUsingAsFeedback");
